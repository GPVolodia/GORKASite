	...
	<div class="container"  id="full">
    	<div id="fs_content">
		    ...
		    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12" id="site_content">
		    	<p id="nav_name">Редагувати завдання<p>
						...
						<div id="profile_inform">
							...
							<font id="some_cool_font">
								...
								<div class="input-group" >
									...
									<input type="text" class="textbox1" id="my_tb2" name="name" value = "<?php echo $task['name'] ?>" > 
								</div><br>
								Опис завдання  :<br>
								<textarea class="textbox1"  name="description" id="textarea_100"   ><?php echo $task['description'] ?></textarea><br>
								<br>
								<div id="full">
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="margin-20px">
										...
										<div class="input-group" >
											...
											<input type="datetime-local" class="textbox1" id="my_tb2" name="date" value="<?php echo $task['date'];?>">
										</div><br>
									</div>
									<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" id="margin-20px" >
										...
										<div class="input-group" >
											...
											<input type="text" class="textbox1" id="my_tb2" name="max_marc" value = "<?php echo $task['max_marc'] ?>" > 
										</div><br>
									</div>
								</div>
								<br>
