	...
	<div class="container"  id="full">
    	<div id="fs_content">
		    ...
		    <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12" id="site_content">
		    	...
		    	<p id="nav_name"><?php echo $reg_reg;?><p>
					<div id="content_writing_style">
						<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12" id="register_field_left">
							<form method="post">
								...
								Група : <br>
								<div class="input-group" >
									<div class="input-group-addon" id="height_30px"><span class="glyphicon glyphicon-flash" id="glyph_register_height"></span></div>
									<input type="text" class="textbox1" id="my_tb2" name="group" value = "<?php echo $_POST['group'] ?>" >
								</div><br>								
						...
						<?php if (count($message) >= 1 ) : ?>
							<font id="some_cool_font"><p  style="border-bottom:solid 1px; font-size:25px;">Вииникли помилки при реєстрації</p></font>
